...
$tpl->define_dynamic(array(
    ...
    'page'            => '../../plugins/SGW_GraphQL/themes/default/view/admin/api_explorer.tpl',
    'page_message'    => 'layout',
    'disabled_block'  => 'page',
    'explorer_block'  => 'page'
));
$tpl->assign(array(
    'TR_PAGE_TITLE' => tohtml(tr('Admin / System tools / API explorer')),
    ...
    'TR_DISABLED'   => tohtml($disabledBy === 'introspection'
        ? tr('The API explorer is switched off because schema introspection is disabled in this installation\'s configuration. Set \'introspection\' to true in the plugin\'s configuration, or use the API directly with a token.')
        : tr('The API explorer is switched off in this installation\'s configuration. Set \'explorer\' to true in the plugin\'s configuration, or use the API directly with a token.')),
