...
// A reseller's own access to the API is an administrator's decision, and
// there is no administrator UI for it in this phase (see api_tokens.php's
// docblock), so this page carries no customerHasApiAccess() gate - the same
// choice the reseller's own token page already makes.
...
$tpl->define_dynamic(array(
    ...
    'page'            => '../../plugins/SGW_GraphQL/themes/default/view/reseller/api_explorer.tpl',
    'page_message'    => 'layout',
    'disabled_block'  => 'page',
    'explorer_block'  => 'page'
));
$tpl->assign(array(
    'TR_PAGE_TITLE' => tohtml(tr('Reseller / Customers / API explorer')),
