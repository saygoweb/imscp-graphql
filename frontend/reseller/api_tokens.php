...
// there is no administrator UI for it in this phase (see api_access.php's
// docblock for the customer-facing half of that decision), so this page
// carries no customerHasApiAccess() gate.
...
$tpl->define_dynamic(array(
    ...
    'page'            => '../../plugins/SGW_GraphQL/themes/default/view/reseller/api_tokens.tpl',
    'page_message'    => 'layout',
...
$tpl->assign(array(
    'TR_PAGE_TITLE'        => tohtml(tr('Reseller / Profile / API tokens')),
